/**
 * This submission uses random paths by choosing a random starting point and extending it in one direction
 * as long as possible. Draws a new random path if remaining nodes cannot be divided into two groups.
 *
 * TLE because of unlikeliness to find correct path this way.
 */

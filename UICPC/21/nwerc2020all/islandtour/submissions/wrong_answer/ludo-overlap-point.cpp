...
bool overlap(int i) {
	// WA: not conform the following statement:
	// "A person may enter an attraction at the same moment another person leaves the attraction, ..."

	// i.e. [t0, t1] does NOT overlap [t1, t2] (t0 < t1 < t2).
